...
<!-- Форма поиска -->
    ...
    <br>
<!-- Все предоставленные работы -->

    <?php
        $contents = mysqli_query($connect, "SELECT work_view.id_work, work_view.name_work, work_view.year, work_view.name_student, direction.name_dir, accepted_users.full_name, accepted_teacher.full_name, work_view.id FROM ((( `work_view` INNER JOIN `direction` ON direction.id = work_view.direction) INNER JOIN `accepted_users` ON accepted_users.id = work_view.whom_work) INNER JOIN `accepted_teacher`ON accepted_teacher.id = work_view.name_lead) ");
                    ...
                    <div class="block_row_ser_teach">
                            ...
                            <div class="block_column_ser_six">
                                <div class="block_item_ser_six">
                                    ...
                                    <a  id="btn_open_teach" href="/vendor/delete_prava.php?id='.<?= $content[7] ?>'"><batton >Удалить</batton></a>
