...
<div class="wrapper_zag_zav">
        <div class="block_m">
            <div class="block_row_m">
                 ...
                 <div class="block_column_m">
                    <div class="blok_item_m">
                        <p id="zag_zav">Новые заявки работ на проверку </p>
...
<!-- Контент страницы -->
    ...
    <?php 
                        ...
                        $select = mysqli_query($connect,"SELECT works_check.name_work, works_check.id, works_check.year, works_check.name_student, accepted_teacher.full_name, direction.name_dir FROM(( `works_check` INNER JOIN `accepted_teacher` ON accepted_teacher.id = works_check.name_lead) INNER JOIN `direction` ON direction.id = works_check.direction) WHERE `email` = '$email_teacher'");
                    ...
                    <div class="block_row_ser">
                            ...
                            <div class="block_column_ser_six">
                                <div class="block_item_ser_six">
                                    ...
                                    <a  id="bt_open" href="/vendor/accept_work_teach.php?id='.<?= $row[1] ?>.'"><batton >Принять</batton></a>
                            ...
                            <div class="block_column_ser_six">
                                <div class="block_item_ser_six">
                                    ...
                                    <a  id="bt_open" href="/vendor/delete_file_teach_new.php?id='.<?= $row[1] ?>.'"><batton >Отклонить</batton></a>
